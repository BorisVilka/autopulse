package ru.autopulse05.android.feature.laximo.presentation.catalogs.auto.components
...
@Composable
fun SearchByVinOrCarcaseSection(
...
@Preview(
  name = "Search By Main Or Carcase Section",
  showBackground = true,
  uiMode = Configuration.UI_MODE_NIGHT_YES
)
@Composable
fun SearchByVinOrCarcaseSectionPreview() {
  SearchByVinOrCarcaseSection(
    vin = FormTextFieldData(),
    onVinChange = {},
    frameName = FormTextFieldData(),
    onFrameNameChange = {},
