package ru.autopulse05.android.feature.info.presentation.about
...
fun AboutScreen() {
  ...
  Column(
    ...
    MarkedList(
      items = listOf(
        PresentationText.Dynamic("ежедневное обновление предложений;"),
        PresentationText.Dynamic("расширенный поиск из предложений;"),
        PresentationText.Dynamic("кроссировка при подборе деталей;"),
        PresentationText.Dynamic("оперативная информация о движении заказа;"),
        PresentationText.Dynamic("работа с документами;"),
        PresentationText.Dynamic("каталоги для подбора деталей.")
      )
    )
  }
}
