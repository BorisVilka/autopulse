package ru.autopulse05.android.feature.info.presentation.payment_and_shipment
...
fun PaymentAndShipmentScreen() {
  ...
  Column(
    ...
    MarkedList(
      items = listOf(
        PresentationText.Dynamic("наличными при получении товара;"),
        PresentationText.Dynamic("банковским переводом;"),
        PresentationText.Dynamic("через шлюз сбербанка.")
      )
    )
    ...
    MarkedList(
      items = listOf(
        PresentationText.Dynamic("в розничных магазинах, в пунктах интернет-магазина;"),
        PresentationText.Dynamic("на сайте.")
      )
    )
